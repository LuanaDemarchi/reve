        ...
        <div class="max-w-6xl mx-auto px-12 flex flex-col md:flex-row gap-16">
            ...
            <div class="md:w-1/2 text-left">
                ...
                <div class="space-y-8 text-lg text-[#4e2d2d]">
                    ...
                    <div>
                        ...
                        <p><strong>Email:</strong> revepasteleria12@gmail.com</p>

                        <p>
                            <strong>Instagram:</strong>
                            <a href="https://www.instagram.com/revepatissiere"
                               target="_blank"
            ...
            <div class="md:w-1/2 w-full h-[450px]">
                ...
                <iframe 
                    ...
                    src="https://www.google.com/maps?q=Av.+3+de+Abril+546,+Corrientes&output=embed">
                </iframe>
